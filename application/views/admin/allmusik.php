...
<table align='center' width='100%' border='0'>
		...
		<div class='spanW'>
<?php if($this->session->userdata('level') == 'admin') { ?> <a href='<?php echo base_url();?>c_admin/hapus_musik/<?php echo $row->id_album; ?>/<?php echo $row->file; ?>' onclick="return confirm('Anda yakin ingin menghapus nya..!!')"><img src='<?php echo base_url(); ?>image/trash.png' class='l' title='Hapus'></img></a><? } ?>
		</div>
</table>
</div>
