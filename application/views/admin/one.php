...
<div class='span5'>
	...
	<div class='span3'>
	<?php
			echo $this->msk->msg('msg','spanO');
			echo $this->msk->msg('msgHapus','spanO');
			echo $this->msk->msg('msgLogin','spanO');
			echo $this->msk->msg('msgchapca','spanO');
	?>
<?php echo form_open_multipart('c_admin/komment_pr',array('method'=>'post'))?>
...
<?php foreach($chapca as $ch): ?>
		...
		<td><input type='text' name='chapca' value='' required></td>
		</tr>
		<tr>
	...
	<div class='span3'>
		<table width='100%'>
			...
			?> 
				...
				<?php 
				if(($asL->view)=='tidak'){ ?><a href='<?php echo base_url();?>c_admin/tidakAktif/<?php echo $asL->id_album; ?>/<?php echo $asL->id_coment; ?>'><img src='<?php echo base_url(); ?>image/no.png' title='Tidak' class='l'></img></a>
				<?php }else{ ?><a href='<?php echo base_url();?>c_admin/aktif/<?php echo $asL->id_album; ?>/<?php echo $asL->id_coment; ?>'><img src='<?php echo base_url(); ?>image/ya.png' class='l' title='Aktif'></img></a>
				<?php }?><a onclick="return confirm('Anda yakin ingin menghapus nya..!!')" href='<?php echo base_url();?>c_admin/hapus_comment/<?php echo $asL->id_album; ?>/<?php echo $asL->id_coment; ?>'><img src='<?php echo base_url(); ?>image/trash.png' class='l' title='Hapus'></img></a></td>
			<?php }}?>
			</tr>
			<tr>
