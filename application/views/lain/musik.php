...
<a href='<?php echo base_url(); ?>first/add_musik'><div class='b'>Tambah</div></a>
	<?php
			echo "<label style='float:right;'>" .$this->msk->msg('msgchapca','spanO')."</label>";
			echo "<label style='float:right;'>" .$this->msk->msg('msgGagal','spanO')."</label>";
			echo "<label style='float:right;'>" .$this->msk->msg('msgSukses','spanO')."</label>";
			echo $this->msk->msg('msg','spanO');
			?>
<hr>
	<label class='a' align='center'> <center>Musik User</center></label>
