...
?>
	<?php
	echo $this->msk->msg('msgChangeBeda','spanO');
	echo $this->msk->msg('msgChangeSukses','spanO');
	echo $this->msk->msg('msgChangeGagal','spanO');
	?>
	<label class='a' align='center'> <center>Password</center></label>
	<hr>
